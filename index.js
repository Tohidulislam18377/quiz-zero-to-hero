...
const displayQuiz = (data) => {
  const mainQizContainer = document.getElementById('quizContainer')
  if (!data) {
  ...
  data.forEach((quiz, i) => {
    ...
    createDiv.innerHTML = `<div class="m-3 py-3 px-4 shadow-sm rounded">
  ...
  mainQizContainer.appendChild(createDiv)
  });
};
